...
L["Toggle Area"] = "Переключить область"
...
L["Disable Row Highlight"] = "Отключить подсветку строки"
L["DisableRowHighlightDesc"] = "Если отмечено, не подсвечивать строку, если вы добыли тот же предмет и количество обновилось."
...
L["Timing"] = "Время"
L["TimingDesc"] = "Настройте задержки исчезновения и другие параметры, связанные с временем."
