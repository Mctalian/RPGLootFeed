...
L["EnableLootHistoryDesc"] = "启用或禁用显示拾取历史的功能"
L["Loot History Size"] = "拾取历史大小"
L["LootHistorySizeDesc"] = "设置拾取历史窗口的大小"
L["Enable Party Loot in Feed"] = "在信息流中启用队伍拾取"
L["EnablePartyLootDesc"] = "启用此选项以在信息流中显示队伍的拾取记录"
L["Enable Secondary Row Text"] = "启用次级行文本"
L["EnableSecondaryRowTextDesc"] = "启用或禁用在次级行中显示额外信息的功能"
L["Secondary Font Size"] = "次级字体大小"
L["SecondaryFontSizeDesc"] = "设置次级行文本的字体大小"
